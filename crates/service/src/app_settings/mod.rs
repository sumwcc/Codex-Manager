...
pub use gateway::{
    ...
    current_gateway_mode, current_gateway_model_forward_rules, current_gateway_originator,
    ...
    current_gateway_user_agent_version, default_gateway_mode, default_gateway_originator,
