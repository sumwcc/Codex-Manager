...
fn account_summary_serialization_matches_compact_contract() {
    let summary = AccountSummary {
        ...
        status_reason_at: Some(1_745_000_010),
        ...
        access_token_expires_at: Some(1_745_000_100),
        refresh_token_expires_at: Some(1_745_000_200),
        refresh_token_changed_at: Some(1_745_000_300),
