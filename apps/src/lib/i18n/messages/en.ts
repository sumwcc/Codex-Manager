...
export const EN_MESSAGES: MessageCatalog = {
  ...
  预热结果: "Warm-up results",
  预热进度: "Warm-up progress",
  "预热任务正在执行，关闭弹窗不会取消后端任务。":
    "The warm-up task is running. Closing this dialog will not cancel the backend task.",
  "预热任务已完成。": "The warm-up task has completed.",
  总数: "Total",
  跳过: "Skipped",
  等待中: "Pending",
  进行中: "Running",
  ...
  结果消息: "Result message",
  暂无数据: "No data",
  "账号不可用或缺少有效 token": "Account unavailable or missing a valid token",
  "账号 AT/RT 已刷新：RT {returned}，轮换 {changed}":
    "Account AT/RT refreshed: RT {returned}, rotation {changed}",
  已返回: "returned",
  未返回: "not returned",
  已轮换: "rotated",
  未轮换: "not rotated",
  "AT/RT 刷新完成：成功{success}个，失败{failed}个，跳过{skipped}个；首个失败：{message}":
    "AT/RT refresh complete: {success} succeeded, {failed} failed, {skipped} skipped; first failure: {message}",
  "AT/RT 刷新完成：成功{success}个，失败{failed}个，跳过{skipped}个":
    "AT/RT refresh complete: {success} succeeded, {failed} failed, {skipped} skipped",
  "AT/RT 刷新完成：成功{success}个，跳过{skipped}个":
    "AT/RT refresh complete: {success} succeeded, {skipped} skipped",
  "RT 已返回{returned}个，RT 已轮换{changed}个，RT 未返回{missing}个":
    "RT returned: {returned}, RT rotated: {changed}, RT not returned: {missing}",
  "本次可能只刷新了 AT，服务端未返回新 RT":
    "This run may have refreshed only AT; the server did not return a new RT",
  ...
  "AT/RT 到期": "AT/RT expires",
  到期时间: "Expiration time",
  "AT 到期": "AT expires",
  "RT 到期": "RT expires",
  "RT 最近替换": "RT last replaced",
  不可用原因: "Unavailable reason",
  状态时间: "Status time",
  无: "None",
  "RT 已被使用": "RT already used",
  "RT 已撤销": "RT revoked",
  "RT 已过期": "RT expired",
  "RT 无效": "RT invalid",
  "RT 刷新被拒绝": "RT refresh rejected",
  用量接口未授权: "Usage API unauthorized",
  用量接口无权限: "Usage API forbidden",
  用量已耗尽: "Usage exhausted",
  账号已停用: "Account deactivated",
  工作区已停用: "Workspace deactivated",
  "Token 刷新成功": "Token refresh succeeded",
  续费时间: "Renewal time",
  已订阅: "Subscribed",
  未订阅: "Not subscribed",
  ...
  "轮训-用量刷新时间": "Rotation - usage refresh time",
  ...
  "顺序优先：按账号候选顺序优先尝试；均衡轮询：按“平台密钥 + 模型”维度轮询可用账号；轮训-用量刷新时间：优先使用 7 天额度窗口重置时间更远的账号，同等情况下 7 天已用比例更低的账号靠前，最后再按用量刷新时间最旧优先。":
    "Ordered: try accounts in candidate order; Balanced: rotate available accounts by “API key + model”; Rotation - usage refresh time: prefer accounts whose 7-day quota window resets later, then lower 7-day usage, then the oldest usage refresh time.",
